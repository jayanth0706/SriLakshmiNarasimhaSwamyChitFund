      ...
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-h2 {
          ...
          font-weight: 700; color: green; margin-bottom: 20px;
        }
        .login-split {
          height: 60%; width: 100%; flex: 1;
        ...
        .login-image-div {
          ...
          padding: 30px; border-right: 1px solid #eee; background: #fff;
        }
        .login-logo {
        ...
        .input-wrapper { position: relative; width: 100%; max-width: 380px; }
        .login-input {
        ...
        .login-btn-wrapper { width: 100%; max-width: 380px; }
        .login-btn {
        ...
        @media (max-width: 600px) {
          ...
          .center-wrapper { height: auto; min-height: 100vh; padding: 24px 16px; justify-content: flex-start; }
          .login-split { flex-direction: column; max-height: none; }
          .login-image-div { border-right: none; border-bottom: 1px solid #eee; max-height: 220px; padding: 20px; }
          .login-form-div { padding: 24px 20px; box-shadow: none; gap: 12px; }
          .input-wrapper, .login-btn-wrapper, .nav-links { max-width: 100%; }
        }
        @media (min-width: 601px) and (max-width: 900px) {
          .login-split { flex-direction: column; max-height: none; }
          .login-image-div { border-right: none; border-bottom: 1px solid #eee; max-height: 220px; }
          .login-form-div { box-shadow: none; gap: 12px; }
          .input-wrapper, .login-btn-wrapper, .nav-links { max-width: 100%; }
        }
      `}</style>
            ...
            <div className="login-form-div">
              ...
              <div className="login-btn-wrapper">
                <button className="login-btn"
                  ...
                  onClick={handleLogin} disabled={!isFormValid || loggingIn}>
